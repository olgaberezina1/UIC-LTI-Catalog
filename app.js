(function () {
  ...
  const LTI_TOOLS = [
    // ── Active tools ────────────────────────────────────────────────
    { name: "Acadly", desc: "Classroom management combining attendance, live polling, assignments, and student-engagement comms.", bb: "yes", cv: "yes", t2: "yes", tags: ["engagement","polling","attendance","async","sync"] },
    ...
    { name: "ClassRanked", desc: "Course difficulty, satisfaction, and instructor-performance insights from verified student feedback.", bb: "no", cv: "research", t2: "—", tags: ["evaluation","analytics","feedback"] },
    { name: "Echo360", desc: "Lecture capture and video management — recording, streaming, and sharing.", bb: "yes", cv: "yes", t2: "yes", tags: ["video","capture","async"] },
    ...
    { name: "Follett Discovery", desc: "Search, adopt, and link textbooks and digital resources within the course environment.", bb: "yes", cv: "no", t2: "—", tags: ["textbook","publisher"] },
    ...
    { name: "LinkedIn Learning", desc: "LinkedIn's professional development and skills-training platform.", bb: "yes", cv: "yes", t2: "yes", tags: ["video","skills","async","professional"] },
    { name: "Lingco", desc: "Language learning platform for interactive activities, assessments, and multimedia content with grade sync.", bb: "no", cv: "yes", t2: "yes", tags: ["writing","humanities"] },
    ...
    { name: "Matlab", desc: "Numerical computing for analysis, modeling, simulation — assignment submission and auto-grading for STEM.", bb: "yes", cv: "retired", t2: "no", tags: ["stem","math","engineering","computing"] },
    ...
    { name: "Panopto", desc: "Lecture capture, video management, and interactive video learning.", bb: "yes", cv: "yes", t2: "yes", tags: ["video","capture","async"] },
    { name: "Panorama", desc: "Surveys and analytics for engagement, well-being, and at-risk insight.", bb: "no", cv: "yes", t2: "—", tags: ["analytics","success","survey","at-risk"] },
    { name: "Parchment Digital Badges", desc: "Issue digital badges and certificates that track skills and achievements.", bb: "yes", cv: "yes", t2: "yes", tags: ["badges","credentials","skills"] },
    ...
    { name: "Photo Roster", desc: "Displays student profile photos throughout the LMS to aid recognition and engagement.", bb: "yes", cv: "yes", t2: "yes", tags: ["attendance","engagement"] },
    ...
    { name: "Poll Everywhere", desc: "Real-time audience response — polling, quizzes, surveys during lectures.", bb: "yes", cv: "no", t2: "yes", tags: ["polling","engagement","sync"] },
    ...
    { name: "SCORM", desc: "Standardized package format for interactive learning modules — compatibility and tracking across LMS.", bb: "yes", cv: "yes", t2: "yes", tags: ["content"] },
    { name: "Soft Chalk Cloud", desc: "Authoring and delivery of interactive online lessons.", bb: "yes", cv: "yes", t2: "yes", tags: ["content","async"] },
    ...
    { name: "Expert TA", desc: "Online physics homework and assessment with automated grading and feedback.", bb: "yes", cv: "yes", t2: "yes", tags: ["stem","practice","homework","assessment"] },
    ...
    { name: "Turning Technologies (PointSolutions)", desc: "Interactive student-response system for real-time polling and classroom engagement.", bb: "yes", cv: "yes", t2: "yes", tags: ["polling","engagement","sync"] },
    ...
    { name: "Virtual Machine", desc: "On-campus computing environment for advanced LMS, media, and integration tasks.", bb: "na", cv: "na", t2: "yes", tags: [] },
    { name: "Wiley (WileyPLUS)", desc: "Wiley content with adaptive learning and assessment.", bb: "yes", cv: "yes", t2: "yes", tags: ["publisher","adaptive","textbook","homework"] },
    { name: "Zoom", desc: "Video conferencing — virtual meetings, webinars, and online sessions inside the LMS.", bb: "yes", cv: "yes", t2: "yes", tags: ["sync","collaboration"] },
    { name: "Zybooks", desc: "Interactive online textbooks with coding exercises and animations for CS and engineering.", bb: "yes", cv: "yes", t2: "yes", tags: ["textbook","cs","coding","stem","practice"] },
    // ── Retired tools ───────────────────────────────────────────────
    { name: "Acrobatiq", desc: "Adaptive learning platform providing personalized instruction and assessment.", bb: "retired", cv: "retired", t2: "—", tags: ["adaptive","assessment"] },
    { name: "Coerll", desc: "Open educational language learning materials and resources.", bb: "retired", cv: "retired", t2: "—", tags: ["humanities"] },
    { name: "ExamSoft Legacy", desc: "Earlier version of ExamSoft delivering secure offline exams with question banking and analytics.", bb: "retired", cv: "retired", t2: "yes", tags: ["assessment","high-stakes","integrity","proctoring"] },
    { name: "Feedback Fruits", desc: "Pedagogical tool suite for peer review, group assignments, and comprehension exercises.", bb: "retired", cv: "retired", t2: "—", tags: ["engagement","writing","discussion"] },
    { name: "For Class", desc: "Student engagement platform for classroom discussions, Q&A, and interactive learning.", bb: "retired", cv: "retired", t2: "—", tags: ["engagement","discussion"] },
    { name: "Gradarius", desc: "Learning management and assessment platform with grading and student analytics.", bb: "retired", cv: "retired", t2: "—", tags: ["analytics","grading"] },
    { name: "Intedashboard", desc: "Team-based learning platform supporting readiness tests, peer evaluation, and collaborative problem-solving.", bb: "retired", cv: "retired", t2: "—", tags: ["assessment","engagement","group"] },
    { name: "Law Evaluation Kit", desc: "Evaluation and assessment platform for law school courses.", bb: "retired", cv: "retired", t2: "—", tags: ["assessment"] },
    { name: "Microsoft OneDrive LTI", desc: "Cloud storage integration for accessing and collaborating on documents within the LMS.", bb: "retired", cv: "retired", t2: "—", tags: ["collaboration"] },
    { name: "Microsoft Teams", desc: "Collaboration platform enabling video conferencing, chat, and team features within the LMS.", bb: "retired", cv: "retired", t2: "—", tags: ["sync","collaboration"] },
