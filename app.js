(function () {
  ...
  const LTI_TOOLS_FALLBACK = [
    ...
    { name: "ATI Testing", desc: "ATI provides nursing education and assessment resources, including practice assessments, learning modules, simulations, and NCLEX preparation tools. Its platform helps nursing programs assess student knowledge, support learning, and prepare students for professional nursing examinations.", bb: "no", cv: "yes", t2: "yes", tags: ["assessment","health","practice","simulation"] },
    ...
    { name: "ExamSoft Enterprise", desc: "ExamSoft is a secure offline exam platform that supports high-stakes assessments, analytics, and question tagging. It ensures controlled testing environments and provides detailed performance reporting.", bb: "yes", cv: "yes", t2: "yes", tags: ["assessment","high-stakes","integrity","proctoring"] },
    { name: "Follett My Materials", desc: "Faculty can discover and adopt the best course materials, made available seamlessly to your students. Students can conveniently acquire all materials with options to choose rental, new, used or digital.", bb: "yes", cv: "yes", t2: "yes", tags: ["textbook","publisher"] },
