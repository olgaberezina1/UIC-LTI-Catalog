(function () {
  ...
  const LTI_TOOLS = [
    ...
    { name: "ATI Testing", desc: "ATI provides nursing education and assessment resources, including practice assessments, learning modules, simulations, and NCLEX preparation tools. Its platform helps nursing programs assess student knowledge, support learning, and prepare students for professional nursing examinations.", bb: "no", cv: "yes", t2: "—", tags: ["assessment","health","practice","simulation"] },
