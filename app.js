(function () {
  ...
  const LTI_TOOLS = [
    ...
    { name: "Gradescope", desc: "An AI-assisted grading platform that streamlines the process of grading assignments, exams, and programming projects with automated feedback and analytics.", bb: "yes", cv: "yes", t2: "yes", tags: ["grading","assessment","stem","ai","writing"] },
    ...
    { name: "iClicker", desc: "iClicker enables real-time polling, quizzes, and attendance tracking to increase student engagement during live classes. Students can respond via mobile app or physical clickers.", bb: "yes", cv: "yes", t2: "yes", tags: ["polling","engagement","attendance","sync","large-class"] },
    { name: "ILP Grading", desc: "ILP Grading (Instructor Learning Platform Grading) provides advanced grading workflows and rubrics for instructors to evaluate student work within Canvas. It supports streamlined scoring, feedback delivery, and integration with the Canvas gradebook.", bb: "no", cv: "yes", t2: "yes", tags: ["grading","assessment"] },
    ...
    { name: "Lucid", desc: "Lucid's LTI integration allows students and instructors to create, edit, and collaborate on diagrams, flowcharts, wireframes, and digital whiteboards directly within Canvas. It supports interactive visual assignments, group work, and embedded diagrams inside course content.", bb: "no", cv: "yes", t2: "yes", tags: ["collaboration","visual","whiteboard","group"] },
    ...
    { name: "McGraw Hill Connect", desc: "A digital learning platform that provides adaptive learning technology, assignments, and assessments integrated with McGraw Hill's educational content.", bb: "yes", cv: "yes", t2: "yes", tags: ["publisher","adaptive","textbook","homework"] },
    ...
    { name: "Panopto", desc: "A comprehensive video platform for education that provides lecture capture, video management, and interactive video learning capabilities.", bb: "yes", cv: "yes", t2: "yes", tags: ["video","capture","async"] },
    ...
    { name: "Piazza", desc: "A Q&A platform designed for academic courses that facilitates student-instructor and peer-to-peer communication and knowledge sharing.", bb: "yes", cv: "yes", t2: "yes", tags: ["discussion","qa","async","large-class","stem"] },
    ...
    { name: "Zoom", desc: "A video conferencing platform integration that enables virtual meetings, webinars, and online classroom sessions within the LMS environment.", bb: "yes", cv: "yes", t2: "yes", tags: ["sync","collaboration"] },
